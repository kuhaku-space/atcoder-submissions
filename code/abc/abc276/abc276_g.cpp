#line 1 "a.cpp"
#define PROBLEM ""
#line 1 "/home/kuhaku/home/github/algo/lib/math/combination.hpp"
#include <cassert>
#include <vector>
#line 2 "/home/kuhaku/home/github/algo/lib/math/modint.hpp"
#include <cstdint>
#include <iostream>
#include <type_traits>
...
int main(void) {
    ...
    rep (i, m / 3 + 1) g[3 * i] = combi(i + n - 2, n - 2);
    rep (loop, 2) {
        rep (i, m) g[i + 1] += g[i];
    }

    Mint ans = 0;
    rep (i, m + 1) ans += f[i] * g[m - i];
    co(ans);
