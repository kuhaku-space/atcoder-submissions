...
#line 6 "/home/kuhaku/home/github/algo/lib/internal/internal_fft.hpp"
...
#line 4 "/home/kuhaku/home/github/algo/lib/fft/ntt.hpp"
...
int main(void) {
    ...
    rep (bit, 5) {
        ...
        auto v = convolution(c, d);
        rep (i, 2 * n - 1) ans[i % n] -= v[i] << bit;
        rep (i, n) ans[i] += n << bit;
    }
