...
#line 2 "/home/kuhaku/home/github/algo/lib/math/eratosthenes.hpp"
...
#line 4 "/home/kuhaku/home/github/algo/lib/internal/internal_math.hpp"
...
#line 4 "/home/kuhaku/home/github/algo/lib/internal/internal_type_traits.hpp"
#include <type_traits>
...
int main(void) {
    ...
    vector v(n, vector(n, Inf));
    auto primes = pn.prime_numbers(1000000);
    rep (i, 20) {
        int r = rand() % primes.size();
        int p = primes[r];
        vector<ll> b(n);
        ...
        rep (i, n) {
            rep (j, n) {
                if (c.count((b[i] * b[j]) % p))
                    chmin(v[i][j], c[(b[i] * b[j]) % p]);
                else
                    v[i][j] = 0;
            }
        }
