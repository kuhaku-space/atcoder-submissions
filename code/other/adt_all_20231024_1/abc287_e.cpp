...
#line 2 "/home/kuhaku/home/github/algo/lib/string/lcp.hpp"
...
int main(void) {
    ...
    vector<int> ans(n);
    rep (i, n - 1) {
        chmax(ans[t[i].second], longest_common_prefix(t[i].first, t[i + 1].first));
        chmax(ans[t[i + 1].second], longest_common_prefix(t[i].first, t[i + 1].first));
    }
    for (auto x : ans) co(x);
