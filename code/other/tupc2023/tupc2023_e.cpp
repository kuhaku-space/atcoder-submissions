...
#line 2 "/home/kuhaku/home/github/algo/lib/math/matrix.hpp"
...
int main(void) {
    ...
    auto f = [&](auto self, int x) -> Mint {
        if (x == 0)
            return 1;
        if (x == 1)
            return sum;
        if (x % 2 == 0) {
            return self(self, x / 2) + self(self, x / 2 - 1);
        } else {
            return self(self, 1) * self(self, x / 2);
        }
    };
